...
p100_f466/ workdir: Hyp3_Mintpy_SBAS and ISCE2_Mintpy_SBAS derive their MintPy output
...
def run_pipeline(workdir: Path) -> None:
    ...
    print("== ISCE2_Mintpy_SBAS prep_data + real MintPy run " + "=" * 37)
    analyzer = ISCE2_Mintpy_SBAS(ISCE2_Mintpy_SBAS_Config(workdir=str(workdir)))
    analyzer.prep_data()
    analyzer.run()
